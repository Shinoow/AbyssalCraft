...
public class WorldHandler implements ILifeCycleHandler {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		BiomeDictionary.registerBiomeType(ACBiomes.darklands_plains, Type.PLAINS, Type.SPOOKY);
		BiomeDictionary.registerBiomeType(ACBiomes.darklands_hills, Type.HILLS, Type.SPOOKY);
		BiomeDictionary.registerBiomeType(ACBiomes.darklands_mountains, Type.MOUNTAIN, Type.SPOOKY);
		BiomeDictionary.registerBiomeType(ACBiomes.coralium_infested_swamp, Type.SWAMP);
