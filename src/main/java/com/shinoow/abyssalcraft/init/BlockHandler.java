...
public class BlockHandler implements ILifeCycleHandler {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		ACBlocks.darkstone_cobblestone = new BlockACBasic(Material.ROCK, 2.2F, 12.0F, SoundType.STONE, MapColor.BLACK).setUnlocalizedName("darkstone_cobble");
		...
		ACBlocks.block_of_abyssalnite = new IngotBlock(2, MapColor.PURPLE).setUnlocalizedName("abyblock");
		...
		ACBlocks.block_of_coralium = new IngotBlock(5, MapColor.CYAN).setUnlocalizedName("corblock");
		...
		ACBlocks.block_of_dreadium = new IngotBlock(6, MapColor.RED).setUnlocalizedName("dreadiumblock");
		...
		ACBlocks.block_of_ethaxium = new IngotBlock(8, MapColor.CLOTH).setResistance(Float.MAX_VALUE).setUnlocalizedName("ethaxiumblock");
		...
		ACBlocks.coralium_cobblestone = new BlockACBasic(Material.ROCK, 2.0F, 10.0F, SoundType.STONE, MapColor.CYAN).setUnlocalizedName("coraliumcobblestone");
	...
	public void init(FMLInitializationEvent event) {
		...
		addCondition(ACBlocks.block_of_coralium, new DimensionCondition(ACLib.abyssal_wasteland_id));
