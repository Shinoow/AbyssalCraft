...
public class BlockHandler implements ILifeCycleHandler {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		ACBlocks.darkstone_cobblestone = new BlockACBasic(Material.rock, 2.2F, 12.0F, SoundType.STONE, MapColor.blackColor).setUnlocalizedName("darkstone_cobble");
		ACBlocks.glowing_darkstone_bricks = new BlockACBasic(Material.rock, "pickaxe", 3, 55F, 3000F, SoundType.STONE, MapColor.blackColor).setLightLevel(1.0F).setUnlocalizedName("dsglow");
		ACBlocks.darkstone_brick_slab = new BlockACSingleSlab(Material.rock, SoundType.STONE, MapColor.blackColor).setHardness(1.65F).setResistance(12.0F).setUnlocalizedName("darkbrickslab1");
		...
		ACBlocks.darkstone_cobblestone_slab = new BlockACSingleSlab(Material.rock, SoundType.STONE, MapColor.blackColor).setHardness(1.65F) .setResistance(12.0F).setUnlocalizedName("darkcobbleslab1");
		...
		ACBlocks.darklands_oak_leaves = new BlockACLeaves(ACBlocks.darklands_oak_sapling, MapColor.blueColor).setHardness(0.2F).setResistance(1.0F).setUnlocalizedName("dltleaves");
		ACBlocks.darklands_oak_wood = new BlockACLog(MapColor.brownColor).setHardness(2.0F).setResistance(1.0F).setUnlocalizedName("dltlog");
		...
		ACBlocks.abyssal_stone_brick_slab = new BlockACSingleSlab(Material.rock, "pickaxe", 2, SoundType.STONE, MapColor.greenColor).setCreativeTab(ACTabs.tabBlock).setHardness(1.8F).setResistance(12.0F).setUnlocalizedName("abyslab1");
		...
		ACBlocks.abyssal_stone_brick_fence = new BlockACFence(Material.rock, "pickaxe", 2, SoundType.STONE, MapColor.greenColor).setHardness(1.8F).setResistance(12.0F).setUnlocalizedName("abyfence");
		...
		ACBlocks.darkstone_slab = new BlockACSingleSlab(Material.rock, SoundType.STONE, MapColor.blackColor).setCreativeTab(ACTabs.tabBlock).setHardness(1.65F).setResistance(12.0F).setUnlocalizedName("darkstoneslab1");
		...
		ACBlocks.darklands_oak_planks = new BlockACBasic(Material.wood, 2.0F, 5.0F, SoundType.WOOD, MapColor.brownColor).setUnlocalizedName("dltplank");
		...
		ACBlocks.darklands_oak_slab = new BlockACSingleSlab(Material.wood, SoundType.WOOD, MapColor.brownColor).setHardness(2.0F).setResistance(5.0F).setUnlocalizedName("dltslab1");
		...
		ACBlocks.darkstone_brick_fence = new BlockACFence(Material.rock, SoundType.STONE, MapColor.blackColor).setHardness(1.65F).setResistance(12.0F).setUnlocalizedName("dsbfence");
		ACBlocks.darklands_oak_fence = new BlockACFence(Material.wood, SoundType.WOOD, MapColor.brownColor).setHardness(2.0F).setResistance(5.0F).setUnlocalizedName("dltfence");
		...
		ACBlocks.abyssalnite_stone_brick = new BlockACBrick(4, 2.5F, 20.0F, MapColor.purpleColor).setUnlocalizedName("abydreadbrick");
		...
		ACBlocks.dreadlands_log = new BlockACLog(MapColor.redColor).setHardness(2.0F).setResistance(12.0F).setUnlocalizedName("dreadlog");
		ACBlocks.dreadlands_leaves = new BlockACLeaves(ACBlocks.dreadlands_sapling, MapColor.redColor).setHardness(0.2F).setResistance(1.0F).setUnlocalizedName("dreadleaves");
		ACBlocks.dreadlands_planks = new BlockACBasic(Material.wood, 2.0F, 5.0F, SoundType.WOOD, MapColor.redColor).setUnlocalizedName("dreadplanks");
		...
		ACBlocks.dreadstone_brick_fence = new BlockACFence(Material.rock, "pickaxe", 4, SoundType.STONE, MapColor.redColor).setHardness(2.5F).setResistance(20.0F).setUnlocalizedName("dreadbrickfence");
		ACBlocks.dreadstone_brick_slab = new BlockACSingleSlab(Material.rock, "pickaxe", 4, SoundType.STONE, MapColor.redColor).setHardness(2.5F).setResistance(20.0F).setUnlocalizedName("dreadbrickslab1");
		...
		ACBlocks.abyssalnite_stone_brick_fence = new BlockACFence(Material.rock, "pickaxe", 4, SoundType.STONE, MapColor.purpleColor).setHardness(2.5F).setResistance(20.0F).setUnlocalizedName("abydreadbrickfence");
		ACBlocks.abyssalnite_stone_brick_slab = new BlockACSingleSlab(Material.rock, "pickaxe", 4, SoundType.STONE, MapColor.purpleColor).setHardness(2.5F).setResistance(20.0F).setUnlocalizedName("abydreadbrickslab1");
		...
		ACBlocks.coralium_stone_brick_fence = new BlockACFence(Material.rock, SoundType.STONE, MapColor.cyanColor).setHardness(1.5F).setResistance(10.0F).setUnlocalizedName("cstonebrickfence");
		ACBlocks.coralium_stone_brick_slab = new BlockACSingleSlab(Material.rock, SoundType.STONE, MapColor.cyanColor).setHardness(1.5F).setResistance(10.0F).setUnlocalizedName("cstonebrickslab1");
		...
		ACBlocks.dreadlands_wood_fence = new BlockACFence(Material.wood, SoundType.WOOD, MapColor.redColor).setHardness(2.0F).setResistance(5.0F).setUnlocalizedName("drtfence");
		...
		ACBlocks.ethaxium = new BlockACBasic(Material.rock, "pickaxe", 8, 100.0F, Float.MAX_VALUE, SoundType.STONE, MapColor.clothColor).setUnlocalizedName("ethaxium");
		...
		ACBlocks.ethaxium_brick_slab = new BlockACSingleSlab(Material.rock, "pickaxe", 8, SoundType.STONE, MapColor.clothColor).setHardness(100.0F).setResistance(Float.MAX_VALUE).setUnlocalizedName("ethaxiumbrickslab1");
		...
		ACBlocks.ethaxium_brick_fence = new BlockACFence(Material.rock, "pickaxe", 8, SoundType.STONE, MapColor.clothColor).setHardness(100.0F).setResistance(Float.MAX_VALUE).setUnlocalizedName("ethaxiumfence");
		ACBlocks.omothol_stone = new BlockACBasic(Material.rock, "pickaxe", 6, 10.0F, 12.0F, SoundType.STONE, MapColor.blackColor).setUnlocalizedName("omotholstone");
		...
		ACBlocks.dark_ethaxium_brick_fence = new BlockACFence(Material.rock, "pickaxe", 8, SoundType.STONE, MapColor.stoneColor).setHardness(150.0F).setResistance(Float.MAX_VALUE).setUnlocalizedName("darkethaxiumbrickfence");
		...
		ACBlocks.monolith_stone = new BlockACBasic(Material.rock, 6.0F, 24.0F, SoundType.STONE, MapColor.blackColor).setUnlocalizedName("monolithstone");
		...
		ACBlocks.dreadlands_dirt = new BlockACBasic(Material.ground, 0.4F, 2.0F, SoundType.GROUND, MapColor.tntColor).setUnlocalizedName("dreadlandsdirt");
		ACBlocks.abyssal_cobblestone = new BlockACBasic(Material.rock, "pickaxe", 2, 2.6F, 12.0F, SoundType.STONE, MapColor.greenColor).setUnlocalizedName("abyssalcobblestone");
		ACBlocks.dreadstone_cobblestone = new BlockACBasic(Material.rock, "pickaxe", 4, 3.3F, 20.0F, SoundType.STONE, MapColor.redColor).setUnlocalizedName("dreadstonecobblestone");
		ACBlocks.abyssalnite_cobblestone = new BlockACBasic(Material.rock, "pickaxe", 4, 3.3F, 20.0F, SoundType.STONE, MapColor.purpleColor).setUnlocalizedName("abyssalnitecobblestone");
		ACBlocks.coralium_cobblestone = new BlockACBasic(Material.rock, 2.0F, 10.0F, SoundType.STONE, MapColor.cyanColor).setUnlocalizedName("coraliumcobblestone");
		...
		ACBlocks.abyssal_cobblestone_slab = new BlockACSingleSlab(Material.rock, "pickaxe", 2, SoundType.STONE, MapColor.greenColor).setHardness(2.6F).setResistance(12.0F).setUnlocalizedName("abyssalcobblestoneslab1");
		...
		ACBlocks.dreadstone_cobblestone_slab = new BlockACSingleSlab(Material.rock, "pickaxe", 4, SoundType.STONE, MapColor.redColor).setHardness(3.3F).setResistance(20.0F).setUnlocalizedName("dreadstonecobblestoneslab1");
		...
		ACBlocks.abyssalnite_cobblestone_slab = new BlockACSingleSlab(Material.rock, "pickaxe", 4, SoundType.STONE, MapColor.purpleColor).setHardness(3.3F).setResistance(20.0F).setUnlocalizedName("abyssalnitecobblestoneslab1");
		...
		ACBlocks.coralium_cobblestone_slab = new BlockACSingleSlab(Material.rock, SoundType.STONE, MapColor.cyanColor).setHardness(2.0F).setResistance(10.0F).setUnlocalizedName("coraliumcobblestoneslab1");
