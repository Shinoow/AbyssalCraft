...
import com.shinoow.abyssalcraft.common.blocks.baseblocks.*;
import com.shinoow.abyssalcraft.common.blocks.baseblocks.BlockACBrick.EnumBrickType;
import com.shinoow.abyssalcraft.common.blocks.baseblocks.BlockACCobblestone.EnumCobblestoneType;
import com.shinoow.abyssalcraft.common.blocks.baseblocks.BlockACStone.EnumStoneType;
...
public class BlockHandler implements ILifeCycleHandler {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		ACBlocks.elysian_stone_brick = new BlockACBrick(4, 2.5F, 20.0F, MapColor.LIGHT_BLUE).setTranslationKey("elysian_stone_brick");
		ACBlocks.chiseled_elysian_stone_brick = new BlockACBrick(4, 2.5F, 20.0F, MapColor.LIGHT_BLUE).setTranslationKey("chiseled_elysian_stone_brick");
		ACBlocks.cracked_elysian_stone_brick = new BlockACBrick(4, 2.5F, 20.0F, MapColor.LIGHT_BLUE).setTranslationKey("cracked_elysian_stone_brick");
		...
		ACBlocks.chiseled_coralium_stone_brick = new BlockACBrick(1.5F, 10.0F, MapColor.CYAN).remap("cstonebrick", EnumBrickType.CHISELED).mipp().setTranslationKey("chiseled_coralium_stone_brick");
		ACBlocks.cracked_coralium_stone_brick = new BlockACBrick(1.5F, 10.0F, MapColor.CYAN).remap("cstonebrick", EnumBrickType.CRACKED).mipp().setTranslationKey("cracked_coralium_stone_brick");
		...
		ACBlocks.ethaxium_brick = new BlockACBrick(8, 100.0F, Float.MAX_VALUE, MapColor.CLOTH).mipp().setTranslationKey("ethaxiumbrick");
		ACBlocks.chiseled_ethaxium_brick = new BlockACBrick(8, 100.0F, Float.MAX_VALUE, MapColor.CLOTH).remap("ethaxiumbrick", EnumBrickType.CHISELED).mipp().setTranslationKey("chiseled_ethaxium_brick");
		ACBlocks.cracked_ethaxium_brick = new BlockACBrick(8, 100.0F, Float.MAX_VALUE, MapColor.CLOTH).remap("ethaxiumbrick", EnumBrickType.CRACKED).mipp().setTranslationKey("cracked_ethaxium_brick");
		ACBlocks.ethaxium_pillar = new BlockEthaxiumPillar(100.0F, MapColor.CLOTH).setTranslationKey("ethaxiumpillar");
		ACBlocks.ethaxium_brick_stairs = new BlockACStairs(ACBlocks.ethaxium_brick, "pickaxe", 8).mipp().setHardness(100.0F).setResistance(Float.MAX_VALUE).setTranslationKey("ethaxiumbrickstairs");
		ACBlocks.ethaxium_brick_slab = new BlockACSingleSlab(Material.ROCK, "pickaxe", 8, SoundType.STONE, MapColor.CLOTH).mipp().setHardness(100.0F).setResistance(Float.MAX_VALUE).setTranslationKey("ethaxiumbrickslab1");
		ethaxiumslab2 = new BlockACDoubleSlab(ACBlocks.ethaxium_brick_slab, Material.ROCK, "pickaxe", 8).mipp().setHardness(100.0F).setResistance(Float.MAX_VALUE).setTranslationKey("ethaxiumbrickslab2");
		...
		ACBlocks.dark_ethaxium_brick = new BlockACBrick(8, 150.0F, Float.MAX_VALUE).mipp().setTranslationKey("darkethaxiumbrick");
		ACBlocks.chiseled_dark_ethaxium_brick = new BlockACBrick(8, 150.0F, Float.MAX_VALUE).remap("darkethaxiumbrick", EnumBrickType.CHISELED).mipp().setTranslationKey("chiseled_dark_ethaxium_brick");
		ACBlocks.cracked_dark_ethaxium_brick = new BlockACBrick(8, 150.0F, Float.MAX_VALUE).remap("darkethaxiumbrick", EnumBrickType.CRACKED).mipp().setTranslationKey("cracked_dark_ethaxium_brick");
		ACBlocks.dark_ethaxium_pillar = new BlockEthaxiumPillar(150.0F, MapColor.STONE).setTranslationKey("darkethaxiumpillar");
		ACBlocks.dark_ethaxium_brick_stairs = new BlockACStairs(ACBlocks.dark_ethaxium_brick, "pickaxe", 8).mipp().setHardness(150.0F).setResistance(Float.MAX_VALUE).setTranslationKey("darkethaxiumbrickstairs");
		ACBlocks.dark_ethaxium_brick_slab = new BlockACSingleSlab(Material.ROCK, "pickaxe", 8, SoundType.STONE).mipp().setHardness(150.0F).setResistance(Float.MAX_VALUE).setTranslationKey("darkethaxiumbrickslab1");
		darkethaxiumslab2 = new BlockACDoubleSlab(ACBlocks.dark_ethaxium_brick_slab, Material.ROCK, "pickaxe", 8).mipp().setHardness(150.0F).setResistance(Float.MAX_VALUE).setTranslationKey("darkethaxiumbrickslab2");
		...
		ACBlocks.ritual_altar_elysian_stone = new BlockRitualAltar(() -> ACBlocks.elysian_cobblestone.getDefaultState(), 2, EnumRitualMatType.ELYSIAN_STONE_BRICK).setTranslationKey("ritualaltar");
		...
		ACBlocks.ritual_pedestal_elysian_stone = new BlockRitualPedestal(() -> ACBlocks.elysian_cobblestone.getDefaultState(), 2, EnumRitualMatType.ELYSIAN_STONE_BRICK).setTranslationKey("ritualpedestal");
		...
		ACBlocks.elysian_cobblestone_slab = new BlockACSingleSlab(Material.ROCK, "pickaxe", 4, SoundType.STONE, MapColor.LIGHT_BLUE).setHardness(3.3F).setResistance(20.0F).setTranslationKey("elysiancobblestoneslab1");
		...
		registerBlock(ACBlocks.abyssal_stone_brick_slab, new ItemSlabAC(ACBlocks.abyssal_stone_brick_slab, ACBlocks.abyssal_stone_brick_slab, abyslab2), "abyslab1");
		registerBlock(abyslab2, new ItemSlabAC(abyslab2, ACBlocks.abyssal_stone_brick_slab, abyslab2), "abyslab2");
		...
		registerBlock(ACBlocks.coralium_stone_brick_slab, new ItemSlabAC(ACBlocks.coralium_stone_brick_slab, ACBlocks.coralium_stone_brick_slab, cstonebrickslab2), "cstonebrickslab1");
		registerBlock(cstonebrickslab2, new ItemSlabAC(cstonebrickslab2, ACBlocks.coralium_stone_brick_slab, cstonebrickslab2), "cstonebrickslab2");
		...
		registerBlock(ACBlocks.ethaxium_brick_slab, new ItemSlabAC(ACBlocks.ethaxium_brick_slab, ACBlocks.ethaxium_brick_slab, ethaxiumslab2), "ethaxiumbrickslab1");
		registerBlock(ethaxiumslab2, new ItemSlabAC(ethaxiumslab2, ACBlocks.ethaxium_brick_slab, ethaxiumslab2), "ethaxiumbrickslab2");
		...
		registerBlock(ACBlocks.dark_ethaxium_brick_slab, new ItemSlabAC(ACBlocks.dark_ethaxium_brick_slab, ACBlocks.dark_ethaxium_brick_slab, darkethaxiumslab2), "darkethaxiumbrickslab1");
		registerBlock(darkethaxiumslab2, new ItemSlabAC(darkethaxiumslab2, ACBlocks.dark_ethaxium_brick_slab, darkethaxiumslab2), "darkethaxiumbrickslab2");
		...
		registerBlock(ACBlocks.abyssal_cobblestone_slab, new ItemSlabAC(ACBlocks.abyssal_cobblestone_slab, ACBlocks.abyssal_cobblestone_slab, abycobbleslab2), "abyssalcobblestoneslab1");
		registerBlock(abycobbleslab2, new ItemSlabAC(abycobbleslab2, ACBlocks.abyssal_cobblestone_slab, abycobbleslab2), "abyssalcobblestoneslab2");
