...
public class MiscHandler implements ILifeCycleHandler {
	...
	private void setResearchItems() {
		...
		addCondition(ACBlocks.dreadlands_sapling, ResearchItems.DREADLANDS);
		addCondition(ACBlocks.dreadlands_log, ResearchItems.DREADLANDS);
		addCondition(ACBlocks.dreadlands_leaves, ResearchItems.DREADLANDS);
		addCondition(ACBlocks.dreadlands_planks, ResearchItems.DREADLANDS);
		...
		addCondition(ACBlocks.dreadlands_wood_fence, ResearchItems.DREADLANDS);
