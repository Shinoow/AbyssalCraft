...
public class EntityHandler implements ILifeCycleHandler {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		EntityRegistry.removeSpawn(EntityDepthsGhoul.class, EnumCreatureType.MONSTER, Biomes.mushroomIslandShore);
		...
		if(evilAnimalSpawnWeight > 0)
			EntityRegistry.addSpawn(EntityEvilpig.class, evilAnimalSpawnWeight, 1, 3, evilAnimalCreatureType ? EnumCreatureType.MONSTER : EnumCreatureType.CREATURE,
					...
					Biomes.extremeHills, Biomes.jungle, Biomes.savannaPlateau, Biomes.swampland,
					Biomes.icePlains, Biomes.birchForest, Biomes.birchForestHills,
					Biomes.roofedForest);
		...
		EntityRegistry.removeSpawn(EntityAbyssalZombie.class, EnumCreatureType.MONSTER, Biomes.mushroomIslandShore);
		...
		EntityRegistry.removeSpawn(EntityLesserShoggoth.class, EnumCreatureType.MONSTER, Biomes.mushroomIslandShore);
