...
public class NecronomiconText {
	...
	public static String MATERIAL_DARKLANDS_GRASS_1 = "necronomicon.text.materials.darklandsgrass.1";
	public static String MATERIAL_DARKLANDS_GRASS_2 = "necronomicon.text.materials.darklandsgrass.2";
	public static String MATERIAL_ABYSSAL_STONE_1 = "necronomicon.text.materials.abyssalstone.1";
	public static String MATERIAL_ABYSSAL_STONE_2 = "necronomicon.text.materials.abyssalstone.2";
	...
	public static String MATERIAL_ABYSSAL_CORALIUM_2 = "necronomicon.text.materials.abyssalcoralium.2";
	public static String MATERIAL_LIQUIFIED_CORALIUM_1 = "necronomicon.text.materials.liquifiedcoralium.1";
	public static String MATERIAL_LIQUIFIED_CORALIUM_2 = "necronomicon.text.materials.liquifiedcoralium.2";
	public static String MATERIAL_PEARLESCENT_CORALIUM_1 = "necronomicon.text.materials.pearlescentcoralium.1";
	public static String MATERIAL_PEARLESCENT_CORALIUM_2 = "necronomicon.text.materials.pearlescentcoralium.2";
	...
	public static String MATERIAL_DREADLANDS_INFUSED_POWERSTONE_2 = "necronomicon.text.materials.powerstonedreadlands.2";
	public static String MATERIAL_DREADSTONE_1 = "necronomicon.text.materials.dreadstone.1";
	public static String MATERIAL_DREADSTONE_2 = "necronomicon.text.materials.dreadstone.2";
	...
	public static String MATERIAL_DREADLANDS_ABYSSALNITE_2 = "necronomicon.text.materials.dreadlandsabyssalnite.2";
	public static String MATERIAL_DREADED_ABYSSALNITE_1 = "necronomicon.text.materials.dreadedabyssalnite.1";
	public static String MATERIAL_DREADED_ABYSSALNITE_2 = "necronomicon.text.materials.dreadedabyssalnite.2";
	public static String MATERIAL_DREADLANDS_GRASS_1 = "necronomicon.text.materials.dreadlandsgrass.1";
	public static String MATERIAL_DREADLANDS_GRASS_2 = "necronomicon.text.materials.dreadlandsgrass.2";
	public static String MATERIAL_DREADLANDS_TREE_1 = "necronomicon.text.materials.dreadlandstree.1";
	public static String MATERIAL_DREADLANDS_TREE_2 = "necronomicon.text.materials.dreadlandstree.2";
	public static String MATERIAL_OMOTHOL_STONE_1 = "necronomicon.text.materials.omotholstone.1";
	public static String MATERIAL_OMOTHOL_STONE_2 = "necronomicon.text.materials.omotholstone.2";
	...
	public static String MATERIAL_DARK_ETHAXIUM_2 = "necronomicon.text.materials.darkethaxium.2";
	...
	public static String CRAFTING_MONOLITH_PILLAR_2 = "necronomicon.text.crafting.monolithpillar.2";
	public static String CRAFTING_RITUAL_CHARM_1 = "necronomicon.text.crafting.ritualcharm.1";
	public static String CRAFTING_RITUAL_CHARM_2 = "necronomicon.text.crafting.ritualcharm.2";
