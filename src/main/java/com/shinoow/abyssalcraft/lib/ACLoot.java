...
public class ACLoot {
	...
	public static final ResourceLocation ENTITY_DEPTHS_GHOUL_WILSON = LootTableList.register(new ResourceLocation("abyssalcraft", "entities/depths_ghoul_wilson"));
	public static final ResourceLocation ENTITY_DEPTHS_GHOUL_ORANGE = LootTableList.register(new ResourceLocation("abyssalcraft", "entities/depths_ghoul_orange"));
	...
	public static final ResourceLocation ENTITY_ANTI_CREEPER = LootTableList.register(new ResourceLocation("abyssalcraft", "entities/anti_creeper"));
	public static final ResourceLocation ENTITY_ANTI_GHOUL = LootTableList.register(new ResourceLocation("abyssalcraft", "entities/anti_ghoul"));
	public static final ResourceLocation ENTITY_ANTI_PIG = LootTableList.register(new ResourceLocation("abyssalcraft", "entities/anti_pig"));
	public static final ResourceLocation ENTITY_ANTI_PLAYER = LootTableList.register(new ResourceLocation("abyssalcraft", "entities/anti_player"));
	public static final ResourceLocation ENTITY_ANTI_SKELETON = LootTableList.register(new ResourceLocation("abyssalcraft", "entities/anti_skeleton"));
	public static final ResourceLocation ENTITY_ANTI_SPIDER = LootTableList.register(new ResourceLocation("abyssalcraft", "entities/anti_spider"));
	public static final ResourceLocation ENTITY_ANTI_ZOMBIE = LootTableList.register(new ResourceLocation("abyssalcraft", "entities/anti_zombie"));
	public static final ResourceLocation ENTITY_DEMON_CHICKEN = LootTableList.register(new ResourceLocation("abyssalcraft", "entities/demon_chicken"));
	...
	public static final ResourceLocation ENTITY_EVIL_COW = LootTableList.register(new ResourceLocation("abyssalcraft", "entities/evil_cow"));
	public static final ResourceLocation ENTITY_EVIL_PIG = LootTableList.register(new ResourceLocation("abyssalcraft", "entities/evil_pig"));
	public static final ResourceLocation ENTITY_FIST_OF_CHAGAROTH = LootTableList.register(new ResourceLocation("abyssalcraft", "entities/fist_of_chagaroth"));
	public static final ResourceLocation ENTITY_GREATER_DREAD_SPAWN = LootTableList.register(new ResourceLocation("abyssalcraft", "entities/greater_dread_spawn"));
	public static final ResourceLocation ENTITY_LESSER_ABYSSAL_SHOGGOTH = LootTableList.register(new ResourceLocation("abyssalcraft", "entities/lesser_abyssal_shoggoth"));
	public static final ResourceLocation ENTITY_LESSER_DREADBEAST = LootTableList.register(new ResourceLocation("abyssalcraft", "entities/lesser_dreadbeast"));
	public static final ResourceLocation ENTITY_LESSER_DREADED_SHOGGOTH = LootTableList.register(new ResourceLocation("abyssalcraft", "entities/lesser_dreaded_shoggoth"));
	public static final ResourceLocation ENTITY_LESSER_OMOTHOL_SHOGGOTH = LootTableList.register(new ResourceLocation("abyssalcraft", "entities/lesser_omothol_shoggoth"));
	public static final ResourceLocation ENTITY_LESSER_SHADOW_SHOGGOTH = LootTableList.register(new ResourceLocation("abyssalcraft", "entities/lesser_shadow_shoggoth"));
	public static final ResourceLocation ENTITY_LESSER_SHOGGOTH = LootTableList.register(new ResourceLocation("abyssalcraft", "entities/lesser_shoggoth"));
	public static final ResourceLocation ENTITY_MINION_OF_THE_GATEKEEPER = LootTableList.register(new ResourceLocation("abyssalcraft", "entities/minion_of_the_gatekeeper"));
	public static final ResourceLocation ENTITY_OMOTHOL_GHOUL = LootTableList.register(new ResourceLocation("abyssalcraft", "entities/omothol_ghoul"));
	public static final ResourceLocation ENTITY_REMNANT = LootTableList.register(new ResourceLocation("abyssalcraft", "entities/remnant"));
	public static final ResourceLocation ENTITY_SHADOW_BEAST = LootTableList.register(new ResourceLocation("abyssalcraft", "entities/shadow_beast"));
	public static final ResourceLocation ENTITY_SHADOW_CREATURE = LootTableList.register(new ResourceLocation("abyssalcraft", "entities/shadow_creature"));
