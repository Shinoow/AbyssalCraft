...
public class EntityDragonMinion extends EntityLiving implements IEntityMultiPart, IMob
{
	...
	private void updateHealingCircle()
    {
        ...
        {
            float f = 32.0F;
            List<?> list = this.worldObj.getEntitiesWithinAABB(EntityDragonBoss.class, this.boundingBox.expand((double)f, (double)f, (double)f));
