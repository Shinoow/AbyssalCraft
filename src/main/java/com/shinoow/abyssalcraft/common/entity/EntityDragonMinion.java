...
public class EntityDragonMinion extends EntityMob implements IEntityMultiPart, ICoraliumEntity
{
	...
	public void onLivingUpdate()
	{
		...
		else
		{
			...
			{
				attackEntitiesInList(world.getEntitiesWithinAABBExcludingEntity(this, dragonPartWing1.getEntityBoundingBox().expand(1.0D, 0.5D, 1.0D).offset(0.0D, -0.5D, 0.0D)));
				attackEntitiesInList(world.getEntitiesWithinAABBExcludingEntity(this, dragonPartWing2.getEntityBoundingBox().expand(1.0D, 0.5D, 1.0D).offset(0.0D, -0.5D, 0.0D)));
