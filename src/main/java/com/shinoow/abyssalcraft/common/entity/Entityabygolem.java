...
public class Entityabygolem extends EntityMob
{
	...
	{
		super(par1World);
		this.tasks.addTask(0, new EntityAIAttackOnCollide(this, Entitydreadgolem.class, 0.35D, true));
		...
		this.targetTasks.addTask(1, new EntityAINearestAttackableTarget(this, Entitydreadgolem.class, 0, true));
	}
