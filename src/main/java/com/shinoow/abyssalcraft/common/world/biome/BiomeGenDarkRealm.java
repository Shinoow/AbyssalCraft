...
public class BiomeGenDarkRealm extends BiomeGenBase {
	...
	public BiomeGenDarkRealm(int par1){
		...
		spawnableMonsterList.add(new SpawnListEntry(EntityShadowCreature.class, 5, 1, 5));
		spawnableMonsterList.add(new SpawnListEntry(EntityShadowMonster.class, 3, 1, 3));
