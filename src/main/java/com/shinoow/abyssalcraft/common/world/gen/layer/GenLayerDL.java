...
public abstract class GenLayerDL extends GenLayer
{
	...
	public static GenLayer[] makeTheWorld(long seed) {
		...
		GenLayer genlayerbiomeedge = new GenLayerBiomesDL(1000L, genlayerriverinit);
		GenLayer lvt_9_1_ = GenLayerZoom.magnify(1000L, genlayerriverinit, 2);
		GenLayer genlayerhills = new GenLayerHillsDL(1000L, genlayerbiomeedge, lvt_9_1_);
		GenLayer genlayer5 = GenLayerZoom.magnify(1000L, genlayerriverinit, 2);
		genlayer5 = GenLayerZoom.magnify(1000L, genlayer5, j);
		GenLayer genlayerriver = new GenLayerRiverDL(1L, genlayer5);
