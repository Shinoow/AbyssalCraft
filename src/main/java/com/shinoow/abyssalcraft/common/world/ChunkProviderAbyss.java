					...
					for (int l2 = 0; l2 < 8; ++l2)
					{
						...
						for (int i3 = 0; i3 < 4; ++i3)
						{
							...
							for (int k3 = 0; k3 < 4; ++k3)
							{
								if ((d15 += d16) > 0.0D)
								{
									p_147424_3_[j3 += short1] = AbyssalCraft.abystone;
								}
								else if (k2 * 8 + l2 < b0)
								{
									p_147424_3_[j3 += short1] = AbyssalCraft.Cwater;
								}
								else
								{
	 ...
	 */
	 ...
	 public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
	 {
				 ...
				 !flag && this.rand.nextInt(4) == 0)
		 {
			 ...
			 (new WorldGenAbyLake(AbyssalCraft.Cwater)).generate(this.worldObj, this.rand, k1, l1, i2);
		 }


		 int Xcoord1 = k + rand.nextInt(16);
		 int Ycoord1 = rand.nextInt(66);
	 ...
	 public List getPossibleCreatures(EnumCreatureType par1EnumCreatureType, int par2, int par3, int par4)
	 {
		 ...
		 return var5 == null ? null : (var5 == AbyssalCraft.Wastelands && par1EnumCreatureType == EnumCreatureType.monster && this.scatteredFeatureGenerator.hasStructureAt(par2, par3, par4) ? this.scatteredFeatureGenerator.getScatteredFeatureSpawnList() : var5.getSpawnableList(par1EnumCreatureType));
	 }

	 @Override
	 public ChunkPosition func_147416_a(World p_147416_1_, String p_147416_2_, int p_147416_3_, int p_147416_4_, int p_147416_5_)
	 {
		 return "AbyStronghold".equals(p_147416_2_) && this.strongholdGenerator != null ? this.strongholdGenerator.func_151545_a(p_147416_1_, p_147416_3_, p_147416_4_, p_147416_5_) : null;
	 }
