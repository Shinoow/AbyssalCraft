							...
							for (int j3 = l2; j3 < i1; ++j3)
							{
								...
								for (int i2 = l; i2 > k2; --i2)
								{
									...
									if (d9 > -0.7D && d10 * d10 + d9 * d9 + d8 * d8 < 1.0D)
									{
										...
										if (iblockstate1 == ACBlocks.dreadstone.getDefaultState() || iblockstate1 == ACBlocks.elysian_stone.getDefaultState() || iblockstate1.getBlock() == ACBlocks.dreadlands_dirt || iblockstate1.getBlock() == ACBlocks.dreadlands_grass)
