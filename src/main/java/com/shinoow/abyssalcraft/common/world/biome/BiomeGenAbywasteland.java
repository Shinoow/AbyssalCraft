	...
	public void decorate(World par1World, Random par2Random, BlockPos pos){
		...
		if(ACConfig.generateLiquifiedCoraliumOre)
			for (int rarity = 0; rarity < 8; rarity++){
				...
				new WorldGenMinable(ACBlocks.liquified_coralium_ore.getDefaultState(), veinSize, BlockHelper.forBlock(ACBlocks.abyssal_stone)).generate(par1World, par2Random, pos.add(x, y, z));
			}
		if(ACConfig.generateAbyssalCoraliumOre)
			for(int rarity = 0; rarity < var5 + 5 + par2Random.nextInt(3); rarity++) {
				...
				new WorldGenMinable(ACBlocks.abyssal_coralium_ore.getDefaultState(), veinSize, BlockHelper.forBlock(ACBlocks.abyssal_stone)).generate(par1World, par2Random, pos.add(x, y, z));
			}
		if(ACConfig.generateAbyssalNitreOre)
			for(int rarity = 0; rarity < 8; rarity++) {
				...
				new WorldGenMinable(ACBlocks.abyssal_nitre_ore.getDefaultState(), veinSize, BlockHelper.forBlock(ACBlocks.abyssal_stone)).generate(par1World, par2Random, pos.add(x, y, z));
			}
		if(ACConfig.generateAbyssalIronOre)
			for(int rarity = 0; rarity < 8; rarity++) {
				...
				new WorldGenMinable(ACBlocks.abyssal_iron_ore.getDefaultState(), veinSize, BlockHelper.forBlock(ACBlocks.abyssal_stone)).generate(par1World, par2Random, pos.add(x, y, z));
			}
		if(ACConfig.generateAbyssalCopperOre)
			for(int rarity = 0; rarity < 8; rarity++) {
				...
				new WorldGenMinable(ACBlocks.abyssal_copper_ore.getDefaultState(), veinSize, BlockHelper.forBlock(ACBlocks.abyssal_stone)).generate(par1World, par2Random, pos.add(x, y, z));
			}
		if(ACConfig.generateAbyssalGoldOre)
			for(int rarity = 0; rarity < 5; rarity++) {
				...
				new WorldGenMinable(ACBlocks.abyssal_gold_ore.getDefaultState(), veinSize, BlockHelper.forBlock(ACBlocks.abyssal_stone)).generate(par1World, par2Random, pos.add(x, y, z));
			}
		if(ACConfig.generateAbyssalDiamondOre)
			for(int rarity = 0; rarity < 5; rarity++) {
				...
				new WorldGenMinable(ACBlocks.abyssal_diamond_ore.getDefaultState(), veinSize, BlockHelper.forBlock(ACBlocks.abyssal_stone)).generate(par1World, par2Random, pos.add(x, y, z));
			}
		if(ACConfig.generatePearlescentCoraliumOre)
			for(int rarity = 0; rarity < var5; rarity++) {
				...
				new WorldGenMinable(ACBlocks.pearlescent_coralium_ore.getDefaultState(), veinSize, BlockHelper.forBlock(ACBlocks.abyssal_stone)).generate(par1World, par2Random, pos.add(x, y, z));
			}
		if(ACConfig.generateAbyssalTinOre)
			for(int rarity = 0; rarity < 8; rarity++) {
				...
				new WorldGenMinable(ACBlocks.abyssal_tin_ore.getDefaultState(), veinSize, BlockHelper.forBlock(ACBlocks.abyssal_stone)).generate(par1World, par2Random, pos.add(x, y, z));
			}
	}
