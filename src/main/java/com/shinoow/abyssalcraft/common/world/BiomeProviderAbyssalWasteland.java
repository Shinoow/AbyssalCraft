...
import com.shinoow.abyssalcraft.common.world.gen.layer.GenLayerAW;
...
public class BiomeProviderAbyssalWasteland extends BiomeProvider
{
	...
	public BiomeProviderAbyssalWasteland()
	{
		biomeCache = new BiomeCache(this);
		biomesToSpawnIn = new ArrayList<>();
		biomesToSpawnIn.add(ACBiomes.abyssal_wastelands);
		biomesToSpawnIn.add(ACBiomes.abyssal_swamp);
		biomesToSpawnIn.add(ACBiomes.abyssal_desert);
		biomesToSpawnIn.add(ACBiomes.abyssal_plateau);
	}

	public BiomeProviderAbyssalWasteland(long par1, WorldType par3WorldType)
	{
		this();
		GenLayer[] agenlayer = GenLayerAW.makeTheWorld(par1);
		biomeToUse = agenlayer[0];
		biomeIndexLayer = agenlayer[1];
	}

	public BiomeProviderAbyssalWasteland(World par1world)
	{
...
//		if (biome == null)
//			return ACBiomes.abyssal_wasteland;
