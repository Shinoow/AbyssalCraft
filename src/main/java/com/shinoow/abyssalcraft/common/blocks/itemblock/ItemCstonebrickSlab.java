...
public class ItemCstonebrickSlab extends ItemBlock
{
	...
	{
		super(block);
		this.field_150949_c = (BlockSlab) AbyssalCraft.cstonebrickslab1;
		this.field_150947_d = (BlockSlab) AbyssalCraft.cstonebrickslab2;
