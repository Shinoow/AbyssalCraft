...
public class ItemDarkstoneSlab extends ItemBlock
{
	...
	{
		super(block);
		this.field_150949_c = (BlockSlab) AbyssalCraft.Darkstoneslab1;
		this.field_150947_d = (BlockSlab) AbyssalCraft.Darkstoneslab2;
