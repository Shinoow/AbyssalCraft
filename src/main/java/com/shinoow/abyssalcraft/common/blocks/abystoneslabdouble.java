...
public class abystoneslabdouble extends BlockSlab
{
	/** The list of the types of step blocks. */
	public abystoneslabdouble(boolean par2)
	{
	...
	{
		if(par1World.getBlock(par2, par3 - 1, par4) == AbyssalCraft.abyslab2)
		{
	...
	{
		return AbyssalCraft.abyslab2.getLocalizedName();
	}
