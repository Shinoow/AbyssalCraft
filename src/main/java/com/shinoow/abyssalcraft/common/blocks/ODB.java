...
public class ODB extends Block
{
	...
	public void onBlockDestroyedByPlayer(World par1World, int par2, int par3, int par4, int par5)
	{
		if (!par1World.isRemote)
		{
			if ((par5 & 1) == 1)
			{
				EntityODBPrimed var6 = new EntityODBPrimed(par1World, par2 + 0.5F, par3 + 0.5F, par4 + 0.5F);
	...
	{
		return par1 == 1 ? ODBTopIcon : par1 == 0 ? ODBBottomIcon : blockIcon;
	}
	...
	{
		blockIcon = par1IconRegister.registerIcon(AbyssalCraft.modid + ":" + "ODBsides");
		ODBTopIcon = par1IconRegister.registerIcon(AbyssalCraft.modid + ":" + "ODBtop");
		ODBBottomIcon = par1IconRegister.registerIcon(AbyssalCraft.modid + ":" + "ODBbottom");
