...
public class BlockShubniggurathStatue extends BlockContainer {
	...
	public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack)
	{
		...
		TileEntityShubniggurathStatue tile = (TileEntityShubniggurathStatue) par1World.getTileEntity(par2, par3, par4);
