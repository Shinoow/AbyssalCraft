...
public class Darkcobbleslab extends BlockSlab
{
	/** The list of the types of step blocks. */
	public Darkcobbleslab(boolean par2)
	{
	...
	{
		if(par1World.getBlock(par2, par3 - 1, par4) == AbyssalCraft.Darkcobbleslab1)
		{
	...
	{
		return p_150003_0_ == AbyssalCraft.Darkcobbleslab1;
	}
	...
	public String func_150002_b(int var1) {
		...
		return AbyssalCraft.Darkcobbleslab1.getLocalizedName();
	}
