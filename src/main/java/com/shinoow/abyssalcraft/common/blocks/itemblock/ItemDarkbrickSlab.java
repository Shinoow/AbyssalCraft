...
public class ItemDarkbrickSlab extends ItemBlock
{
	...
	{
		super(block);
		this.field_150949_c = (BlockSlab) AbyssalCraft.Darkbrickslab1;
		this.field_150947_d = (BlockSlab) AbyssalCraft.Darkbrickslab2;
