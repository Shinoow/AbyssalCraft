...
public class Dreadbrickslab extends BlockSlab
{
	/** The list of the types of step blocks. */
	public Dreadbrickslab(boolean par2)
	{
	...
	{
		if(par1World.getBlock(par2, par3 - 1, par4) == AbyssalCraft.dreadbrickslab1)
		{
	...
	public String func_150002_b(int var1) {
		...
		return AbyssalCraft.dreadbrickslab1.getLocalizedName();
	}
}