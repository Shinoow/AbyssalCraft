...
public class BlockTeleporterDL extends BlockBreakable
{
	...
	{
		this.blockIcon = par1IconRegister.registerIcon(AbyssalCraft.modid + ":" + "DG");
	}
	...
	public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity)
	{
		if ((par5Entity.ridingEntity == null) && (par5Entity.riddenByEntity == null) && ((par5Entity instanceof EntityPlayerMP)))
		{
			...
			else if (thePlayer.dimension != AbyssalCraft.dimension2)
			{
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, AbyssalCraft.dimension2, new TeleporterDreadlands(thePlayer.mcServer.worldServerForDimension(AbyssalCraft.dimension2)));
			}
			else {
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, AbyssalCraft.dimension, new TeleporterDreadlands(thePlayer.mcServer.worldServerForDimension(AbyssalCraft.dimension)));
			}
		}
	}
	@SideOnly(Side.CLIENT)
