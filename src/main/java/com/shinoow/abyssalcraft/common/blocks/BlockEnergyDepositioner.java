...
public class BlockEnergyDepositioner extends BlockACBasic {
	...
	public boolean onBlockActivated(World par1World, BlockPos pos, IBlockState state, EntityPlayer par5EntityPlayer, EnumHand hand, ItemStack heldItem, EnumFacing side, float par7, float par8, float par9) {
		...
		if(heldItem != null && heldItem.getItem() instanceof ItemCharm) return false;
	...
	public void breakBlock(World world, BlockPos pos, IBlockState state)
	{
		...
		TileEntityEnergyDepositioner generator = (TileEntityEnergyDepositioner) world.getTileEntity(pos);
		...
		if(generator != null){
			...
			PEUtils.writeManipulatorNBT(generator, stack.getTagCompound());
