...
public class AbyDreadbrickslab extends BlockSlab
{
	/** The list of the types of step blocks. */
	public AbyDreadbrickslab(boolean par2)
	{
	...
	{
		if(par1World.getBlock(par2, par3 - 1, par4) == AbyssalCraft.abydreadbrickslab1)
		{
	...
	{
		return p_150003_0_ == AbyssalCraft.abydreadbrickslab1;
	}
	...
	public String func_150002_b(int var1) {
		...
		return AbyssalCraft.abydreadbrickslab1.getLocalizedName();
	}
}