...
public class abystoneslab extends BlockSlab
{
	/** The list of the types of step blocks. */
	public abystoneslab(boolean par2)
	{
	...
	{
		if(par1World.getBlock(par2, par3 - 1, par4) == AbyssalCraft.abyslab1)
		{
			par1World.setBlock(par2, par3, par4, Blocks.air);
			par1World.setBlock(par2, par3 - 1, par4, AbyssalCraft.abyslab2);
		}
	}
	...
	{
		return p_150003_0_ == AbyssalCraft.abyslab1;
	}
	...
	public String func_150002_b(int var1) {
		...
		return AbyssalCraft.abyslab1.getLocalizedName();
	}
}