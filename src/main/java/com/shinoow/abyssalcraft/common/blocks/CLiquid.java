...
public class CLiquid extends BlockFluidClassic {
	...
	public CLiquid() {
		super(AbyssalCraft.CFluid, Cwater);
		//AbyssalCraft.CFluid.setBlock(this);
	}

	@Override
	@SideOnly(Side.CLIENT)
	public void registerBlockIcons(IIconRegister iconRegister) {
		this.theIcon = new IIcon[]{iconRegister.registerIcon("abyssalcraft:cwater_still"), iconRegister.registerIcon("abyssalcraft:cwater_flow")};
	}
