...
public class Cstonebrickslab extends BlockSlab
{
	/** The list of the types of step blocks. */
	public Cstonebrickslab(boolean par2)
	{
	...
	{
		if(par1World.getBlock(par2, par3 - 1, par4) == AbyssalCraft.cstonebrickslab1)
		{
	...
	{
		return p_150003_0_ == AbyssalCraft.cstonebrickslab1;
	}
	...
	public String func_150002_b(int var1) {
		...
		return AbyssalCraft.cstonebrickslab1.getLocalizedName();
	}
}