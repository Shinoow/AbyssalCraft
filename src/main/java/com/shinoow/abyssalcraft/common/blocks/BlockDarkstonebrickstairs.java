...
public class BlockDarkstonebrickstairs extends BlockStairs
{
	...
	public BlockDarkstonebrickstairs(int j)
	{
		super(AbyssalCraft.Darkstone_brick, j);
		setLightOpacity(0);
	...
	@Override
	public boolean func_150145_f(IBlockAccess par1IBlockAccess, int par2, int par3, int par4)
	{
