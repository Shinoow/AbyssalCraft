...
public class DLTslabdouble extends BlockSlab
{
	/** The list of the types of step blocks. */
	public DLTslabdouble(boolean par2)
	{
	...
	{
		return AbyssalCraft.DLTslab1.getItemDropped(par1, par2Random, par3);
	}

	public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLiving par5EntityLiving)
	{
		if(par1World.getBlock(par2, par3 - 1, par4) == AbyssalCraft.DLTslab2)
		{
			par1World.setBlock(par2, par3, par4, Blocks.air);
			par1World.setBlock(par2, par3 - 1, par4, AbyssalCraft.DLTslab2);
		}
	}
	/**
	...
	{
		return p_150003_0_ == AbyssalCraft.DLTslab2;
	}
	...
	{
		return AbyssalCraft.DLTslab2.getLocalizedName();
	}
