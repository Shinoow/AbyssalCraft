...
public class Darkbrickslabdouble extends BlockSlab
{
	/** The list of the types of step blocks. */
	public Darkbrickslabdouble(boolean par2)
	{
	...
	{
		return AbyssalCraft.Darkbrickslab1.getItemDropped(par1, par2Random, par3);
	}

	public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLiving par5EntityLiving)
	{
		if(par1World.getBlock(par2, par3 - 1, par4) == AbyssalCraft.Darkbrickslab2)
		{
	...
	{
		return p_150003_0_ == AbyssalCraft.Darkbrickslab2;
	}
	...
	{
		return AbyssalCraft.Darkbrickslab2.getLocalizedName();
	}
