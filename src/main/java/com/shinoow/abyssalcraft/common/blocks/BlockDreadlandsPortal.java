...
public class BlockDreadlandsPortal extends BlockBreakable {
	...
	public void onEntityCollidedWithBlock(World par1World, BlockPos pos, IBlockState state, Entity par5Entity)
	{
		if (!par5Entity.isRiding() && !par5Entity.isBeingRidden() && par5Entity instanceof EntityPlayerMP)
		{
			...
			{
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getPlayerList().transferPlayerToDimension(thePlayer, AbyssalCraft.configDimId2, new TeleporterDreadlands(thePlayer.mcServer.worldServerForDimension(AbyssalCraft.configDimId2)));
			}
			else {
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getPlayerList().transferPlayerToDimension(thePlayer, AbyssalCraft.configDimId1, new TeleporterDreadlands(thePlayer.mcServer.worldServerForDimension(AbyssalCraft.configDimId1)));
			}
		}
	}
	...
	public BlockPattern.PatternHelper func_181089_f(World p_181089_1_, BlockPos p_181089_2_)
	{
		...
		BlockDreadlandsPortal.Size blockportal$size = new BlockDreadlandsPortal.Size(p_181089_1_, p_181089_2_, EnumFacing.Axis.X);
		...
		if (!blockportal$size.func_150860_b())
		{
			...
			blockportal$size = new BlockDreadlandsPortal.Size(p_181089_1_, p_181089_2_, EnumFacing.Axis.Z);
		}
