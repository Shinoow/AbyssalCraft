...
public class BlockRendingPedestal extends BlockContainer implements IEnergyBlock {
	...
	public BlockRendingPedestal() {
		...
		setDefaultState(blockState.getBaseState().withProperty(BlockTiltablePedestal.TILTED, false));
	}
	...
	{
		return getDefaultState().withProperty(BlockTiltablePedestal.TILTED, (meta & 1) > 0);
	}

	@Override
	public int getMetaFromState(IBlockState state)
	{
		return state.getValue(BlockTiltablePedestal.TILTED) ? 1 : 0;
	}

	@Override
	protected BlockStateContainer createBlockState()
	{
		return new BlockStateContainer.Builder(this).add(BlockTiltablePedestal.TILTED).build();
	}
}
