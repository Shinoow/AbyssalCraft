...
public class BlockAzathothStatue extends BlockContainer {

	public BlockAzathothStatue() {
		super(Material.rock);
		setHardness(6.0F);
		setResistance(12.0F);
	...
	public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack)
	{
		...
		TileEntityAzathothStatue tile = (TileEntityAzathothStatue) par1World.getTileEntity(par2, par3, par4);
