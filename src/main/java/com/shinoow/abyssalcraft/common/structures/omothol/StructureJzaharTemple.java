...
public class StructureJzaharTemple extends WorldGenerator {
	...
	private void firstFloor(World world, Random rand, BlockPos pos){//TODO: first floor starts here
		...
		world.setBlockState(pos.add(0, 7, 65), ACBlocks.dark_ethaxium_brick.getDefaultState().withProperty(BlockDarkEthaxiumBrick.TYPE, EnumBrickType.CHISELED), 2);
		world.setBlockState(pos.add(0, 7, 0), ACBlocks.dark_ethaxium_brick.getDefaultState().withProperty(BlockDarkEthaxiumBrick.TYPE, EnumBrickType.CHISELED), 2);
		for(int z = -2; z < 3; z++)
			for(int y = 1; y < 7; y++){
		...
		world.setBlockState(pos.add(-17, 7, 33), ACBlocks.dark_ethaxium_brick.getDefaultState().withProperty(BlockDarkEthaxiumBrick.TYPE, EnumBrickType.CHISELED), 2);
		world.setBlockState(pos.add(17, 7, 33), ACBlocks.dark_ethaxium_brick.getDefaultState().withProperty(BlockDarkEthaxiumBrick.TYPE, EnumBrickType.CHISELED), 2);
		for(int z = 8; z < 59; z++)
			for(int y = 1; y < 11; y++){
				if(z == 8 || z == 58){
	...
	private void secondFloor(World world, Random rand, BlockPos pos){//TODO: second floor starts here
		...
		world.setBlockState(pos.add(1, 12, 76), ACBlocks.dark_ethaxium_brick_slab.getDefaultState(), 2);
		world.setBlockState(pos.add(-2, 13, 77), ACBlocks.dark_ethaxium_brick.getDefaultState().withProperty(BlockDarkEthaxiumBrick.TYPE, EnumBrickType.CHISELED), 2);
		world.setBlockState(pos.add(2, 13, 77), ACBlocks.dark_ethaxium_brick.getDefaultState().withProperty(BlockDarkEthaxiumBrick.TYPE, EnumBrickType.CHISELED), 2);
		...
		world.setBlockState(pos.add(-4, 17, 88), ACBlocks.dark_ethaxium_brick.getDefaultState().withProperty(BlockDarkEthaxiumBrick.TYPE, EnumBrickType.CHISELED), 2);
		world.setBlockState(pos.add(4, 17, 88), ACBlocks.dark_ethaxium_brick.getDefaultState().withProperty(BlockDarkEthaxiumBrick.TYPE, EnumBrickType.CHISELED), 2);
		for(int x = -7; x < 8; x++)
			for(int z = 66; z < 90; z++){
		...
		world.setBlockState(pos.add(0, 18, 65), ACBlocks.dark_ethaxium_brick.getDefaultState().withProperty(BlockDarkEthaxiumBrick.TYPE, EnumBrickType.CHISELED), 2);
		for(int z = -2; z < 3; z++)
			for(int y = 12; y < 18; y++){
				world.setBlockToAir(pos.add(-18, y, z + 33));
				world.setBlockToAir(pos.add(18, y, z + 33));
		...
		world.setBlockState(pos.add(-17, 18, 33), ACBlocks.dark_ethaxium_brick.getDefaultState().withProperty(BlockDarkEthaxiumBrick.TYPE, EnumBrickType.CHISELED), 2);
		world.setBlockState(pos.add(17, 18, 33), ACBlocks.dark_ethaxium_brick.getDefaultState().withProperty(BlockDarkEthaxiumBrick.TYPE, EnumBrickType.CHISELED), 2);
		for(int z = 8; z < 60; z++)
			for(int y = 12; y < 22; y++){
				if(z == 8 || z == 58){
