...
public class StructureDreadlandsMineBPieces
{
	...
	{
		MapGenStructureIO.func_143031_a(StructureDreadlandsMineBPieces.Corridor.class, "DLMSBCorridor");
		MapGenStructureIO.func_143031_a(StructureDreadlandsMineBPieces.Cross.class, "DLMSBCrossing");
		MapGenStructureIO.func_143031_a(StructureDreadlandsMineBPieces.Room.class, "DLMSBRoom");
		MapGenStructureIO.func_143031_a(StructureDreadlandsMineBPieces.Stairs.class, "DLMSBStairs");
	}
	...
	private static StructureComponent getRandomComponent(List<StructureComponent> par0List, Random par1Random, int par2, int par3, int par4, int par5, int par6)
	{
		...
		if (j1 >= 80)
		{
			structureboundingbox = StructureDreadlandsMineBPieces.Cross.findValidPlacement(par0List, par1Random, par2, par3, par4, par5);

			if (structureboundingbox != null)
			{
				return new StructureDreadlandsMineBPieces.Cross(par6, par1Random, structureboundingbox, par5);
			}
		}
		else if (j1 >= 70)
		{
			structureboundingbox = StructureDreadlandsMineBPieces.Stairs.findValidPlacement(par0List, par1Random, par2, par3, par4, par5);

			if (structureboundingbox != null)
			{
				return new StructureDreadlandsMineBPieces.Stairs(par6, par1Random, structureboundingbox, par5);
			}
		}
		else
		{
			structureboundingbox = StructureDreadlandsMineBPieces.Corridor.findValidPlacement(par0List, par1Random, par2, par3, par4, par5);

			if (structureboundingbox != null)
			{
				return new StructureDreadlandsMineBPieces.Corridor(par6, par1Random, structureboundingbox, par5);
			}
		}
	...
	public static class Corridor extends StructureComponent
	{
		...
		public void buildComponent(StructureComponent par1StructureComponent, List par2List, Random par3Random)
		{
			...
			case 0:
				if (j <= 1)
				{
					StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.minX, this.boundingBox.minY - 1 + par3Random.nextInt(3), this.boundingBox.maxZ + 1, this.coordBaseMode, i);
				}
				else if (j == 2)
				{
					StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.minX - 1, this.boundingBox.minY - 1 + par3Random.nextInt(3), this.boundingBox.maxZ - 3, 1, i);
				}
				else
				{
					StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.maxX + 1, this.boundingBox.minY - 1 + par3Random.nextInt(3), this.boundingBox.maxZ - 3, 3, i);
				}
			...
			case 1:
				if (j <= 1)
				{
					StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.minX - 1, this.boundingBox.minY - 1 + par3Random.nextInt(3), this.boundingBox.minZ, this.coordBaseMode, i);
				}
				else if (j == 2)
				{
					StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.minX, this.boundingBox.minY - 1 + par3Random.nextInt(3), this.boundingBox.minZ - 1, 2, i);
				}
				else
				{
					StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.minX, this.boundingBox.minY - 1 + par3Random.nextInt(3), this.boundingBox.maxZ + 1, 0, i);
				}
			...
			case 2:
				if (j <= 1)
				{
					StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.minX, this.boundingBox.minY - 1 + par3Random.nextInt(3), this.boundingBox.minZ - 1, this.coordBaseMode, i);
				}
				else if (j == 2)
				{
					StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.minX - 1, this.boundingBox.minY - 1 + par3Random.nextInt(3), this.boundingBox.minZ, 1, i);
				}
				else
				{
					StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.maxX + 1, this.boundingBox.minY - 1 + par3Random.nextInt(3), this.boundingBox.minZ, 3, i);
				}
			...
			case 3:
				if (j <= 1)
				{
					StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.maxX + 1, this.boundingBox.minY - 1 + par3Random.nextInt(3), this.boundingBox.minZ, this.coordBaseMode, i);
				}
				else if (j == 2)
				{
					StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.maxX - 3, this.boundingBox.minY - 1 + par3Random.nextInt(3), this.boundingBox.minZ - 1, 2, i);
				}
				else
				{
					StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.maxX - 3, this.boundingBox.minY - 1 + par3Random.nextInt(3), this.boundingBox.maxZ + 1, 0, i);
				}
			}
			...
			if (i < 8)
			{
				...
				if (this.coordBaseMode != 2 && this.coordBaseMode != 0)
				{
					for (k = this.boundingBox.minX + 3; k + 3 <= this.boundingBox.maxX; k += 5)
					{
						...
						if (l == 0)
						{
							StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, k, this.boundingBox.minY, this.boundingBox.minZ - 1, 2, i + 1);
						}
						else if (l == 1)
						{
							StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, k, this.boundingBox.minY, this.boundingBox.maxZ + 1, 0, i + 1);
						}
					}
				}
				else
				{
					for (k = this.boundingBox.minZ + 3; k + 3 <= this.boundingBox.maxZ; k += 5)
					{
						...
						if (l == 0)
						{
							StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.minX - 1, this.boundingBox.minY, k, 1, i + 1);
						}
						else if (l == 1)
						{
							StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.maxX + 1, this.boundingBox.minY, k, 3, i + 1);
						}
					}
				}
			}
	...
	public static class Cross extends StructureComponent
	{
		...
		public void buildComponent(StructureComponent par1StructureComponent, List par2List, Random par3Random)
		{
			...
			{
			case 0:
				StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.maxZ + 1, 0, i);
				StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ + 1, 1, i);
				StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ + 1, 3, i);
				break;
			case 1:
				StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.minZ - 1, 2, i);
				StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.maxZ + 1, 0, i);
				StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ + 1, 1, i);
				break;
			case 2:
			...
			if (this.isMultipleFloors)
			{
				...
				{
					StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.minX + 1, this.boundingBox.minY + 3 + 1, this.boundingBox.minZ - 1, 2, i);
				}

				if (par3Random.nextBoolean())
				{
					StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.minX - 1, this.boundingBox.minY + 3 + 1, this.boundingBox.minZ + 1, 1, i);
				}

				if (par3Random.nextBoolean())
				{
					StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.maxX + 1, this.boundingBox.minY + 3 + 1, this.boundingBox.minZ + 1, 3, i);
				}

				if (par3Random.nextBoolean())
				{
					StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.minX + 1, this.boundingBox.minY + 3 + 1, this.boundingBox.maxZ + 1, 0, i);
				}
			}
		}
	...
	public static class Room extends StructureComponent
	{
		...
		public void buildComponent(StructureComponent par1StructureComponent, List par2List, Random par3Random)
		{
			...
			for (j = 0; j < this.boundingBox.getXSize(); j += 4)
			{
				...
				structurecomponent1 = StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.minX + j, this.boundingBox.minY + par3Random.nextInt(k) + 1, this.boundingBox.minZ - 1, 2, i);
			...
			for (j = 0; j < this.boundingBox.getXSize(); j += 4)
			{
				...
				structurecomponent1 = StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.minX + j, this.boundingBox.minY + par3Random.nextInt(k) + 1, this.boundingBox.maxZ + 1, 0, i);
			...
			for (j = 0; j < this.boundingBox.getZSize(); j += 4)
			{
				...
				structurecomponent1 = StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.minX - 1, this.boundingBox.minY + par3Random.nextInt(k) + 1, this.boundingBox.minZ + j, 1, i);
			...
			for (j = 0; j < this.boundingBox.getZSize(); j += 4)
			{
				...
				structurecomponent1 = StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.maxX + 1, this.boundingBox.minY + par3Random.nextInt(k) + 1, this.boundingBox.minZ + j, 3, i);
	...
	public static class Stairs extends StructureComponent
	{
		...
		public void buildComponent(StructureComponent par1StructureComponent, List par2List, Random par3Random)
		{
			...
			{
			case 0:
				StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.maxZ + 1, 0, i);
				break;
			case 1:
				StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ, 1, i);
				break;
			case 2:
				StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ - 1, 2, i);
				break;
			case 3:
				StructureDreadlandsMineBPieces.getNextMineShaftComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ, 3, i);
			}
		}
