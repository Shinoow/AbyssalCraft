...
public class MapGenDreadlandsMineB extends MapGenStructure
{
    private double field_82673_e = 0.004D;

    public MapGenDreadlandsMineB() {}

    public String func_143025_a()
    {
        return "Dreadlands Mineshaft B";
    }

    public MapGenDreadlandsMineB(Map<?, ?> par1Map)
    {
    ...
    {
        return new StructureDreadlandsMineBStart(this.worldObj, this.rand, par1, par2);
    }
}