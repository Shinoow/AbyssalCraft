...
public class MapGenDreadlandsMineA extends MapGenStructure
{
    private double field_82673_e = 0.004D;

    public MapGenDreadlandsMineA() {}

    public String func_143025_a()
    {
        return "Dreadlands Mineshaft A";
    }

    public MapGenDreadlandsMineA(Map<?, ?> par1Map)
    {
    ...
    {
        return new StructureDreadlandsMineAStart(this.worldObj, this.rand, par1, par2);
    }
}