...
/**
 * Patched PathNavigateGround (see comment further down)
 */
public class PatchedPathNavigateGround extends PathNavigateGround {

	public PatchedPathNavigateGround(EntityLiving entitylivingIn, World worldIn) {
