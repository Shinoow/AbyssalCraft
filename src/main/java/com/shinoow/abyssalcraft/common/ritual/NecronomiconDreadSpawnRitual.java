...
public class NecronomiconDreadSpawnRitual extends NecronomiconRitual {
	...
	public NecronomiconDreadSpawnRitual() {
		super("dreadSpawn", 2, 500F, new Object[]{ACItems.dread_fragment, new ItemStack(ACBlocks.dreadstone), new ItemStack(ACBlocks.elysian_stone), ACItems.dreaded_shoggoth_flesh,
				Items.LEATHER, Items.ROTTEN_FLESH, ACItems.dreaded_shard_of_abyssalnite, ACItems.abyssalnite_ingot});
