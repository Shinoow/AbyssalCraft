...
public class InternalNecroDataHandler extends DummyNecroDataHandler {
	...
	public void registerInternalPages() {
		...
		Pages.ENTITY_ABYSSALNITE_GOLEM_1 = new Page(1, NecronomiconText.LABEL_INFORMATION_ENTITIES, 2, NecronomiconResources.ABYSSALNITE_GOLEM, NecronomiconText.ENTITY_ABYSSALNITE_GOLEM_1, ResearchItems.ABYSSALNITE_GOLEM);
		Pages.ENTITY_ABYSSALNITE_GOLEM_2 = new Page(2, NecronomiconText.LABEL_INFORMATION_ENTITIES, 2, NecronomiconText.ENTITY_ABYSSALNITE_GOLEM_2, ResearchItems.ABYSSALNITE_GOLEM);
		Pages.ENTITY_DREADED_ABYSSALNITE_GOLEM_1 = new Page(3, NecronomiconText.LABEL_INFORMATION_ENTITIES, 2, NecronomiconResources.DREADED_ABYSSALNITE_GOLEM, NecronomiconText.ENTITY_DREADED_ABYSSALNITE_GOLEM_1, ResearchItems.DREADED_ABYSSALNITE_GOLEM);
		Pages.ENTITY_DREADED_ABYSSALNITE_GOLEM_2 = new Page(4, NecronomiconText.LABEL_INFORMATION_ENTITIES, 2, NecronomiconText.ENTITY_DREADED_ABYSSALNITE_GOLEM_2, ResearchItems.DREADED_ABYSSALNITE_GOLEM);
		Pages.ENTITY_DREADLING_1 = new Page(5, NecronomiconText.LABEL_INFORMATION_ENTITIES, 2, NecronomiconResources.DREADLING, NecronomiconText.ENTITY_DREADLING_1, ResearchItems.DREADLING);
		Pages.ENTITY_DREADLING_2 = new Page(6, NecronomiconText.LABEL_INFORMATION_ENTITIES, 2, NecronomiconText.ENTITY_DREADLING_2, ResearchItems.DREADLING);
		Pages.ENTITY_DREAD_SPAWN_1 = new Page(7, NecronomiconText.LABEL_INFORMATION_ENTITIES, 2, NecronomiconResources.DREAD_SPAWN, NecronomiconText.ENTITY_DREAD_SPAWN_1, ResearchItems.DREAD_SPAWN);
		Pages.ENTITY_DREAD_SPAWN_2 = new Page(8, NecronomiconText.LABEL_INFORMATION_ENTITIES, 2, NecronomiconText.ENTITY_DREAD_SPAWN_2, ResearchItems.DREAD_SPAWN);
		Pages.ENTITY_DEMON_ANIMALS_1 = new Page(9, NecronomiconText.LABEL_INFORMATION_ENTITIES, 2, NecronomiconResources.DEMON_ANIMALS, NecronomiconText.ENTITY_DEMON_ANIMALS_1, ResearchItems.DEMON_ANIMAL);
		Pages.ENTITY_DEMON_ANIMALS_2 = new Page(10, NecronomiconText.LABEL_INFORMATION_ENTITIES, 2, NecronomiconText.ENTITY_DEMON_ANIMALS_2, ResearchItems.DEMON_ANIMAL);
		Pages.ENTITY_SPAWN_OF_CHAGAROTH_1 = new Page(11, NecronomiconText.LABEL_INFORMATION_ENTITIES, 2, NecronomiconResources.SPAWN_OF_CHAGAROTH, NecronomiconText.ENTITY_SPAWN_OF_CHAGAROTH_1, ResearchItems.SPAWN_OF_CHAGAROTH);
		Pages.ENTITY_SPAWN_OF_CHAGAROTH_2 = new Page(12, NecronomiconText.LABEL_INFORMATION_ENTITIES, 2, NecronomiconText.ENTITY_SPAWN_OF_CHAGAROTH_2, ResearchItems.SPAWN_OF_CHAGAROTH);
		Pages.ENTITY_FIST_OF_CHAGAROTH_1 = new Page(13, NecronomiconText.LABEL_INFORMATION_ENTITIES, 2, NecronomiconResources.FIST_OF_CHAGAROTH, NecronomiconText.ENTITY_FIST_OF_CHAGAROTH_1, ResearchItems.FIST_OF_CHAGAROTH);
		Pages.ENTITY_FIST_OF_CHAGAROTH_2 = new Page(14, NecronomiconText.LABEL_INFORMATION_ENTITIES, 2, NecronomiconText.ENTITY_FIST_OF_CHAGAROTH_2, ResearchItems.FIST_OF_CHAGAROTH);
		Pages.ENTITY_DREADGUARD_1 = new Page(15, NecronomiconText.LABEL_INFORMATION_ENTITIES, 2, NecronomiconResources.DREADGUARD, NecronomiconText.ENTITY_DREADGUARD_1, ResearchItems.DREADGUARD);
		Pages.ENTITY_DREADGUARD_2 = new Page(16, NecronomiconText.LABEL_INFORMATION_ENTITIES, 2, NecronomiconText.ENTITY_DREADGUARD_2, ResearchItems.DREADGUARD);
		Pages.ENTITY_CHAGAROTH_1 = new Page(17, NecronomiconText.LABEL_INFORMATION_ENTITIES, 2, NecronomiconResources.CHAGAROTH, NecronomiconText.ENTITY_CHAGAROTH_1);
		Pages.ENTITY_CHAGAROTH_2 = new Page(18, NecronomiconText.LABEL_INFORMATION_ENTITIES, 2, NecronomiconText.ENTITY_CHAGAROTH_2);
		Pages.ENTITY_DREADLANDS_SHOGGOTH_1 = new Page(19, NecronomiconText.LABEL_INFORMATION_ENTITIES, 2, NecronomiconResources.LESSER_SHOGGOTH, NecronomiconText.ENTITY_LESSER_SHOGGOTH_1, ResearchItems.SHOGGOTH);
		Pages.ENTITY_DREADLANDS_SHOGGOTH_2 = new Page(20, NecronomiconText.LABEL_INFORMATION_ENTITIES, 2, NecronomiconText.ENTITY_LESSER_SHOGGOTH_2, ResearchItems.SHOGGOTH);
		...
		Chapters.DREADLANDS_MOBS.addPages(Pages.ENTITY_ABYSSALNITE_GOLEM_1, Pages.ENTITY_ABYSSALNITE_GOLEM_2, Pages.ENTITY_DREADED_ABYSSALNITE_GOLEM_1, Pages.ENTITY_DREADED_ABYSSALNITE_GOLEM_2, Pages.ENTITY_DREADLING_1, Pages.ENTITY_DREADLING_2, Pages.ENTITY_DREAD_SPAWN_1, Pages.ENTITY_DREAD_SPAWN_2, Pages.ENTITY_DEMON_ANIMALS_1, Pages.ENTITY_DEMON_ANIMALS_2, Pages.ENTITY_SPAWN_OF_CHAGAROTH_1, Pages.ENTITY_SPAWN_OF_CHAGAROTH_2, Pages.ENTITY_FIST_OF_CHAGAROTH_1, Pages.ENTITY_FIST_OF_CHAGAROTH_2, Pages.ENTITY_DREADGUARD_1, Pages.ENTITY_DREADGUARD_2, Pages.ENTITY_CHAGAROTH_1, Pages.ENTITY_CHAGAROTH_2, Pages.ENTITY_DREADLANDS_SHOGGOTH_1, Pages.ENTITY_DREADLANDS_SHOGGOTH_2);
		...
		new Thread("AbyssalCraft Necronomicon Patreon data") {
			...
			public void run() {
				...
				try {
					...
					chapter.addPage(new Page(1, NecronomiconText.LABEL_PATRONS, 0, new ResourceLocation("abyssalcraft", "textures/gui/necronomicon/patreon/jenni_mort.png"), "Nobody :/"));
				}
