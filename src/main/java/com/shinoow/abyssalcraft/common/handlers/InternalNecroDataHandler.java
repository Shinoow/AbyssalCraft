...
public class InternalNecroDataHandler extends DummyNecroDataHandler {
	...
	public InternalNecroDataHandler(){
		...
		Chapters.ITEM_TRANSPORT_SYSTEM = new Chapter("itemtransportsystem", NecronomiconText.LABEL_INFORMATION_ITEM_TRANSPORT_SYSTEM, 1, ResearchItems.getBookResearch(1));
		...
		Chapters.RITUAL_CHARMS_INFO = new Chapter("ritualcharminfo", NecronomiconText.LABEL_INFORMATION_RITUAL_CHARMS, 0);
		Chapters.PE_UPGRADING = new Chapter("upgrading", NecronomiconText.LABEL_UPGRADING_PE, 0);
		...
		internalNecroData.add(new NecroData("potentialenergy", NecronomiconText.LABEL_POTENTIAL_ENERGY, 0, Chapters.PE_INFO, Chapters.PE_MATERIALS, Chapters.PE_CRAFTING, placesOfPower, Chapters.IDOLS, Chapters.RITUAL_CHARMS_INFO, new GuiInstanceBase(0, NecronomiconText.LABEL_INFORMATION_CRAFTING_RITUAL_CHARMS, "crafingritualcharms", 7), Chapters.PE_UPGRADING));
	...
	public void registerInternalPages() {
		...
		Pages.ENTITY_GHOUL_1 = new Page(17, NecronomiconText.LABEL_INFORMATION_ENTITIES, 0, NecronomiconResources.GHOUL, NecronomiconText.ENTITY_GHOUL_1, ResearchItems.GHOUL);
		Pages.ENTITY_GHOUL_2 = new Page(18, NecronomiconText.LABEL_INFORMATION_ENTITIES, 0, NecronomiconText.ENTITY_GHOUL_2, ResearchItems.GHOUL);
		Pages.ENTITY_SHOGGOTH_1 = new Page(18, NecronomiconText.LABEL_INFORMATION_ENTITIES, 0, NecronomiconResources.LESSER_SHOGGOTH, NecronomiconText.ENTITY_LESSER_SHOGGOTH_1, ResearchItems.SHOGGOTH);
		Pages.ENTITY_SHOGGOTH_2 = new Page(19, NecronomiconText.LABEL_INFORMATION_ENTITIES, 0, NecronomiconText.ENTITY_LESSER_SHOGGOTH_2, ResearchItems.SHOGGOTH);
		...
		Pages.ENTITY_DREADED_GHOUL_1 = new Page(15, NecronomiconText.LABEL_INFORMATION_ENTITIES, 2, NecronomiconResources.GHOUL, NecronomiconText.ENTITY_DREADED_GHOUL_1, ResearchItems.DREADED_GHOUL);
		Pages.ENTITY_DREADED_GHOUL_2 = new Page(16, NecronomiconText.LABEL_INFORMATION_ENTITIES, 2, NecronomiconText.ENTITY_DREADED_GHOUL_2, ResearchItems.DREADED_GHOUL);
		Pages.ENTITY_DREADLANDS_SHOGGOTH_1 = new Page(17, NecronomiconText.LABEL_INFORMATION_ENTITIES, 2, NecronomiconResources.LESSER_SHOGGOTH, NecronomiconText.ENTITY_LESSER_SHOGGOTH_1, ResearchItems.SHOGGOTH);
		Pages.ENTITY_DREADLANDS_SHOGGOTH_2 = new Page(18, NecronomiconText.LABEL_INFORMATION_ENTITIES, 2, NecronomiconText.ENTITY_LESSER_SHOGGOTH_2, ResearchItems.SHOGGOTH);
		...
		Pages.BIOME_DREADLANDS = new Page(1, NecronomiconText.LABEL_INFORMATION_BIOMES, 2, NecronomiconResources.BIOME_DREADLANDS, NecronomiconText.WIP);
		...
		Pages.ITEM_TRANSPORT_TUT_6 = new Page(6, NecronomiconText.LABEL_INFORMATION_ITEM_TRANSPORT_SYSTEM, 1, NecronomiconResources.ITEM_TRANSPORT_TUT_2, NecronomiconText.ITEM_TRANSPORT_TUT_6);
		Pages.ITEM_TRANSPORT_TUT_7 = new Page(7, NecronomiconText.LABEL_INFORMATION_ITEM_TRANSPORT_SYSTEM, 1, NecronomiconText.ITEM_TRANSPORT_TUT_7);
		Pages.ITEM_TRANSPORT_TUT_8 = new Page(8, NecronomiconText.LABEL_INFORMATION_ITEM_TRANSPORT_SYSTEM, 1, new ItemStack(ACBlocks.spirit_altar), NecronomiconText.ITEM_TRANSPORT_TUT_8);
		Pages.ITEM_TRANSPORT_TUT_9 = new Page(9, NecronomiconText.LABEL_INFORMATION_ITEM_TRANSPORT_SYSTEM, 1, NecronomiconResources.ITEM_TRANSPORT_TUT_3, NecronomiconText.ITEM_TRANSPORT_TUT_9);
		Pages.ITEM_TRANSPORT_TUT_10 = new Page(10, NecronomiconText.LABEL_INFORMATION_ITEM_TRANSPORT_SYSTEM, 1, NecronomiconText.ITEM_TRANSPORT_TUT_10);
		...
		Pages.ENTITY_SHADOW_GHOUL_1 = new Page(9, NecronomiconText.LABEL_INFORMATION_ENTITIES, 3, NecronomiconResources.GHOUL, NecronomiconText.ENTITY_SHADOW_GHOUL_1, ResearchItems.SHADOW_GHOUL);
		Pages.ENTITY_SHADOW_GHOUL_2 = new Page(10, NecronomiconText.LABEL_INFORMATION_ENTITIES, 3, NecronomiconText.ENTITY_SHADOW_GHOUL_2, ResearchItems.SHADOW_GHOUL);
		Pages.ENTITY_SHADOW_SHOGGOTH_1 = new Page(11, NecronomiconText.LABEL_INFORMATION_ENTITIES, 3, NecronomiconResources.LESSER_SHOGGOTH, NecronomiconText.ENTITY_LESSER_SHOGGOTH_1, ResearchItems.SHOGGOTH);
		Pages.ENTITY_SHADOW_SHOGGOTH_2 = new Page(12, NecronomiconText.LABEL_INFORMATION_ENTITIES, 3, NecronomiconText.ENTITY_LESSER_SHOGGOTH_2, ResearchItems.SHOGGOTH);
		...
		Pages.PE_TUT_19 = new Page(19, NecronomiconText.LABEL_POTENTIAL_ENERGY, 0, NecronomiconText.PE_TUT_19);
		...
		Pages.INFORMATION_RITUAL_CHARMS_1 = new Page(1, NecronomiconText.LABEL_INFORMATION_RITUAL_CHARMS, 0, NecronomiconText.RITUAL_CHARMS_INFO_1);
		Pages.INFORMATION_RITUAL_CHARMS_2 = new Page(2, NecronomiconText.LABEL_INFORMATION_RITUAL_CHARMS, 0, NecronomiconResources.RITUAL_CHARMS_1, NecronomiconText.RITUAL_CHARMS_INFO_2);
		...
		Pages.INFORMATION_RITUAL_CHARMS_1.setReference(Pages.CRAFTING_RITUAL_CHARM, Pages.PE_TUT_19);
		Pages.PE_UPGRADING_1.setReference(Pages.INFORMATION_MACHINE_1);
		...
		Chapters.ABYSSAL_WASTELAND_BIOMES.addPages(Pages.BIOME_ABYSSAL_WASTELAND, Pages.BIOME_ABYSSAL_DESERT, Pages.BIOME_ABYSSAL_PLATEAU, Pages.BIOME_ABYSSAL_SWAMP, Pages.BIOME_CORALIUM_LAKE); //TODO biomes
		Chapters.ABYSSAL_WASTELAND_STRUCTURES.addPage(Pages.CHAINS); //TODO structures
		...
		Chapters.DREADLANDS_BIOMES.addPages(Pages.BIOME_DREADLANDS, Pages.BIOME_DREADLANDS_MOUNTAINS, Pages.BIOME_DREADLANDS_FOREST, Pages.BIOME_DREADLANDS_OCEAN); //TODO biomes
		...
		Chapters.ITEM_TRANSPORT_SYSTEM.addPages(Pages.ITEM_TRANSPORT_TUT_1, Pages.ITEM_TRANSPORT_TUT_2, Pages.ITEM_TRANSPORT_TUT_3, Pages.ITEM_TRANSPORT_TUT_4, Pages.ITEM_TRANSPORT_TUT_5, Pages.ITEM_TRANSPORT_TUT_6, Pages.ITEM_TRANSPORT_TUT_7, Pages.ITEM_TRANSPORT_TUT_8, Pages.ITEM_TRANSPORT_TUT_9, Pages.ITEM_TRANSPORT_TUT_10);
		Chapters.OMOTHOL.addPage(Pages.INFORMATION_OMOTHOL); //TODO dimensions
		Chapters.OMOTHOL_BIOMES.addPage(Pages.BIOME_OMOTHOL); //TODO biomes
		...
		Chapters.DARK_REALM_MOBS.addPages(Pages.ENTITY_SHADOW_CREATURE_DR_1, Pages.ENTITY_SHADOW_CREATURE_DR_2, Pages.ENTITY_SHADOW_MONSTER_DR_1, Pages.ENTITY_SHADOW_MONSTER_DR_2, Pages.ENTITY_SHADOW_BEAST_DR_1, Pages.ENTITY_SHADOW_BEAST_DR_2, Pages.ENTITY_SACTHOTH_1, Pages.ENTITY_SACTHOTH_2, Pages.ENTITY_SHADOW_GHOUL_1, Pages.ENTITY_SHADOW_GHOUL_2, Pages.ENTITY_SHADOW_SHOGGOTH_1, Pages.ENTITY_SHADOW_SHOGGOTH_2);
		Chapters.DARK_REALM.addPage(Pages.INFORMATION_DARK_REALM); //TODO dimensions
		Chapters.DARK_REALM_BIOMES.addPage(Pages.BIOME_DARK_REALM); //TODO biomes
		...
		Chapters.RITUAL_CHARMS_INFO.addPages(Pages.INFORMATION_RITUAL_CHARMS_1, Pages.INFORMATION_RITUAL_CHARMS_2);
		Chapters.PE_UPGRADING.addPages(Pages.PE_UPGRADING_1, Pages.PE_UPGRADING_2, Pages.PE_UPGRADING_3);
