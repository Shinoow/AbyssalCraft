...
public class InternalNecroDataHandler extends DummyNecroDataHandler {
	...
	public void registerInternalPages() {
		...
		//TODO Add page about the Spirit Altar and how to use it
		...
		Pages.ITEM_TRANSPORT_TUT_8 = new Page(8, NecronomiconText.LABEL_INFORMATION_ITEM_TRANSPORT_SYSTEM, 1, NecronomiconText.ITEM_TRANSPORT_TUT_8);
