...
public class ItemStaff extends ItemACBasic implements IStaffOfRending{
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack stack, World world, EntityPlayer player, EnumHand hand) {
		...
		else return ACItems.staff_of_rending.onItemRightClick(stack, world, player, hand);
	}
	...
	public EnumActionResult onItemUse(ItemStack stack, EntityPlayer player, World world, BlockPos pos, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ){
		...
		else return ACItems.rlyehian_gateway_key.onItemUse(stack, player, world, pos, hand, side, hitX, hitY, hitZ);
	}
