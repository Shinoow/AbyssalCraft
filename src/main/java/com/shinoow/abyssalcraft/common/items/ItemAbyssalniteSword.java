...
public class ItemAbyssalniteSword extends ItemSword {

	private float weaponDamage;
	private final EnumToolMaterialAC toolMaterial;
	public ItemAbyssalniteSword(EnumToolMaterialAC abyssalnite)
	{
		super(ToolMaterial.valueOf("ABYSSALNITE"));
		toolMaterial = abyssalnite;
		maxStackSize = 1;
		setMaxDamage(abyssalnite.getMaxUses());
		weaponDamage = 4 + abyssalnite.getDamageVsEntity();
	}
