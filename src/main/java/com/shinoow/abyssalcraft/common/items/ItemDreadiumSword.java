...
public class ItemDreadiumSword extends ItemSword {

	private float weaponDamage;
	private final EnumToolMaterialAC toolMaterial;
	public ItemDreadiumSword(EnumToolMaterialAC dreadium)
	{
		super(ToolMaterial.valueOf("DREADIUM"));
		toolMaterial = dreadium;
		maxStackSize = 1;
		setMaxDamage(dreadium.getMaxUses());
