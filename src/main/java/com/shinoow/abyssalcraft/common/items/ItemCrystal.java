...
public class ItemCrystal extends Item implements ICrystal {
	...
	public String getItemStackDisplayName(ItemStack par1ItemStack) {
		if(postfix)
			return StatCollector.translateToLocalFormatted(getUnlocalizedName().substring(5)+ ".postfix", StatCollector.translateToLocal("item.crystal." + ACLib.crystalNames[par1ItemStack.getItemDamage()] + ".name"));
		else return StatCollector.translateToLocal(getUnlocalizedName() + "." + ACLib.crystalNames[par1ItemStack.getItemDamage()] + ".name");
	}
}
