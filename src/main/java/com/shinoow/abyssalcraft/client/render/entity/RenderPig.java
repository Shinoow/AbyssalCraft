...
public class RenderPig extends RenderLiving
{
	...
	public void renderPig(Entityevilpig entity, double par2, double par4, double par6, float par8, float par9)
	{
	...
	{
		renderPig((Entityevilpig)par1EntityLiving, par2, par4, par6, par8, par9);
	}

	public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9)
	{
		renderPig((Entityevilpig)par1Entity, par2, par4, par6, par8, par9);
	}
