...
public class TileEntitySacrificialAltarRenderer extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
		...
		Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("abyssalcraft", "textures/model/blocks/SacrificialAltar.png"));
		model.render((Entity)null, 0.0F, 0.0F, -0.1F, 0.0F, 0.0F, 0.0625F);

		TileEntitySacrificialAltar altar = (TileEntitySacrificialAltar) te;
	...
	public void renderBlockSacrificialAltar(TileEntitySacrificialAltar tl, World world, int i, int j, int k, Block block) {
