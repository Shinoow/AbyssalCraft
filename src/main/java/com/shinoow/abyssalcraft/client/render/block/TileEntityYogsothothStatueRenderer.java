...
public class TileEntityYogsothothStatueRenderer extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
		...
		TileEntityYogsothothStatue tile = (TileEntityYogsothothStatue) te;
	...
	public void renderBlockYogsothothStatue(TileEntityYogsothothStatue tl, World world, int i, int j, int k, Block block) {
