...
public class RenderDragonMinion extends RenderLiving
{
    ...
    protected void rotateDragonBody(EntityDragonMinion par1EntityDragonMinion, float par2, float par3, float par4)
    {
        ...
        {
            float f5 = ((float)par1EntityDragonMinion.deathTime + par4 - 1.0F) / 20.0F * 1.6F;
            ...
            GL11.glRotatef(f5 * this.getDeathMaxRotation(par1EntityDragonMinion), 0.0F, 0.0F, 1.0F);
        }
    }
    ...
    protected void renderDragonModel(EntityDragonMinion par1EntityDragonMinion, float par2, float par3, float par4, float par5, float par6, float par7)
    {
        ...
        {
            float f6 = (float)par1EntityDragonMinion.deathTicks / 200.0F;
        ...
        this.bindEntityTexture(par1EntityDragonMinion);
        this.mainModel.render(par1EntityDragonMinion, par2, par3, par4, par5, par6, par7);
    ...
    protected void renderDragonDying(EntityDragonMinion par1EntityDragonMinion, float par2)
    {
        ...
        if (par1EntityDragonMinion.deathTicks > 0)
        {
            ...
            float f1 = ((float)par1EntityDragonMinion.deathTicks + par2) / 200.0F;
            float f2 = 0.0F;
    ...
    {
        this.renderDragon((EntityDragonMinion)par1EntityLiving, par2, par4, par6, par8, par9);
    }
    ...
    {
        return this.renderGlow((EntityDragonMinion)par1EntityLivingBase, par2, par3);
    }

    protected void renderEquippedItems(EntityLivingBase par1EntityLivingBase, float par2)
    {
        this.renderDragonDying((EntityDragonMinion)par1EntityLivingBase, par2);
    }

    protected void rotateCorpse(EntityLivingBase par1EntityLivingBase, float par2, float par3, float par4)
    {
        this.rotateDragonBody((EntityDragonMinion)par1EntityLivingBase, par2, par3, par4);
    }
    ...
    {
        this.renderDragonModel((EntityDragonMinion)par1EntityLivingBase, par2, par3, par4, par5, par6, par7);
    }

    public void renderPlayer(EntityLivingBase par1EntityLivingBase, double par2, double par4, double par6, float par8, float par9)
    {
        this.renderDragon((EntityDragonMinion)par1EntityLivingBase, par2, par4, par6, par8, par9);
    }

    protected ResourceLocation getEntityTexture(Entity par1Entity)
    {
        return this.func_110841_a((EntityDragonMinion)par1Entity);
    }
    ...
    {
        this.renderDragon((EntityDragonMinion)par1Entity, par2, par4, par6, par8, par9);
    }
