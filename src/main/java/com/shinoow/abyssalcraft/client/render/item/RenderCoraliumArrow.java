...
public class RenderCoraliumArrow extends Render<EntityCoraliumArrow>
{
	...
	@Override
	public void doRender(EntityCoraliumArrow entity, double x, double y, double z, float entityYaw, float partialTicks)
	{
