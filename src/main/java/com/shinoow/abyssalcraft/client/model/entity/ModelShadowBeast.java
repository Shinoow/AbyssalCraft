...
public class ModelShadowBeast extends ModelBase {
	...
	public ModelShadowBeast()
	{
		...
		larm2.addBox(-1.5F, 0F, -1.5F, 3, 7, 3);
		larm2.setRotationPoint(6.5F, 2.5F, 0.5F);
		larm2.setTextureSize(128, 64);
		larm2.mirror = true;
		setRotation(larm2, -0.7807508F, 0F, 0F);
		laspike1 = new ModelRenderer(this, 0, 0);
		laspike1.addBox(0F, -4F, 0F, 1, 4, 1);
		laspike1.setRotationPoint(7F, 0F, 0F);
		laspike1.setTextureSize(128, 64);
		laspike1.mirror = true;
		setRotation(laspike1, 0F, 0F, 0.8179311F);
		laspike2 = new ModelRenderer(this, 0, 0);
		laspike2.addBox(0F, -4F, 0F, 1, 4, 1);
		laspike2.setRotationPoint(7F, 5F, -2.5F);
		laspike2.setTextureSize(128, 64);
		laspike2.mirror = true;
		setRotation(laspike2, -1.189716F, 1.07818F, 0.8179311F);
		lfinger1 = new ModelRenderer(this, 30, 0);
		lfinger1.addBox(0F, 0F, 0F, 1, 5, 1);
		lfinger1.setRotationPoint(8F, 6F, -3.5F);
		...
		lfinger3.addBox(0F, 0.5F, 0F, 1, 5, 1);
		lfinger3.setRotationPoint(6F, 4F, -4.5F);
		...
		lfinger2.addBox(0F, 0F, 0F, 1, 5, 1);
		lfinger2.setRotationPoint(4F, 6F, -3.5F);
		...
		lfinger4.addBox(0F, 1F, 0F, 1, 5, 1);
		lfinger4.setRotationPoint(6F, 6.5F, -1.5F);
		...
		rarm2.addBox(-1.5F, 0F, -1.5F, 3, 7, 3);
		rarm2.setRotationPoint(-6.5F, 2.5F, 0.5F);
		rarm2.setTextureSize(128, 64);
		rarm2.mirror = true;
		setRotation(rarm2, -0.7807508F, 0F, 0F);
		raspike1 = new ModelRenderer(this, 0, 0);
		raspike1.addBox(0F, -4F, 0F, 1, 4, 1);
		raspike1.setRotationPoint(-8F, 0F, 0F);
		raspike1.setTextureSize(128, 64);
		raspike1.mirror = true;
		setRotation(raspike1, 0F, 0F, -0.8179294F);
		raspike2 = new ModelRenderer(this, 0, 0);
		raspike2.addBox(-1F, -4F, -1F, 1, 4, 1);
		raspike2.setRotationPoint(-7F, 5F, -2.5F);
		raspike2.setTextureSize(128, 64);
		raspike2.mirror = true;
		setRotation(raspike2, 1.338436F, 1.747392F, -0.8179311F);
		rfinger1 = new ModelRenderer(this, 30, 0);
		rfinger1.addBox(0F, 0F, 0F, 1, 5, 1);
		rfinger1.setRotationPoint(-5F, 6F, -3.5F);
		rfinger1.setTextureSize(128, 64);
		rfinger1.mirror = true;
		setRotation(rfinger1, -0.7807556F, 0F, 0F);
		fringer2 = new ModelRenderer(this, 30, 0);
		fringer2.addBox(0F, 0F, 0F, 1, 5, 1);
		fringer2.setRotationPoint(-9F, 6F, -3.5F);
		fringer2.setTextureSize(128, 64);
		fringer2.mirror = true;
		setRotation(fringer2, -0.7807556F, 0F, 0F);
		rfinger3 = new ModelRenderer(this, 30, 0);
		rfinger3.addBox(0F, 0.5F, 0F, 1, 5, 1);
		rfinger3.setRotationPoint(-7F, 4F, -4.5F);
		...
		rfinger4.addBox(0F, 1F, 0F, 1, 5, 1);
		rfinger4.setRotationPoint(-7F, 6.5F, -1.5F);
