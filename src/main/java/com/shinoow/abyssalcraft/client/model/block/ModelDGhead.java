...
public class ModelDGhead extends ModelBase
{
  ...
  public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity)
  {
      ...
      this.Tooth1.rotateAngleY = par4 / (180F / (float)Math.PI);
      this.Tooth1.rotateAngleX = par5 / (180F / (float)Math.PI);
      
      this.Tooth2.rotateAngleY = par4 / (180F / (float)Math.PI);
      this.Tooth2.rotateAngleX = par5 / (180F / (float)Math.PI);
      
      this.Tooth3.rotateAngleY = par4 / (180F / (float)Math.PI);
      this.Tooth3.rotateAngleX = par5 / (180F / (float)Math.PI);
      
      this.Tooth4.rotateAngleY = par4 / (180F / (float)Math.PI);
      this.Tooth4.rotateAngleX = par5 / (180F / (float)Math.PI);
      
      this.Tooth5.rotateAngleY = par4 / (180F / (float)Math.PI);
      this.Tooth5.rotateAngleX = par5 / (180F / (float)Math.PI);
  }
