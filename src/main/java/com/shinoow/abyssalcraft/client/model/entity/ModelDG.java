...
public class ModelDG extends ModelBase
{
   ...
   public void render(Entity par1Entity, float par2, float par3, float par4, float par5, float par6, float par7)
   {
        ...
        tooth1.rotateAngleX = 0.2365561F;
        tooth1.rotateAngleY = 0F;
        tooth1.rotateAngleZ = 0F;
        tooth1.render(par7);

        tooth2.rotateAngleX = 0.2365561F;
        tooth2.rotateAngleY = 0F;
        tooth2.rotateAngleZ = 0F;
        tooth2.render(par7);

        tooth3.rotateAngleX = 0.2365561F;
        tooth3.rotateAngleY = 0F;
        tooth3.rotateAngleZ = 0F;
        tooth3.render(par7);

        tooth4.rotateAngleX = 0.2365561F;
        tooth4.rotateAngleY = 0F;
        tooth4.rotateAngleZ = 0F;
        tooth4.render(par7);

        tooth5.rotateAngleX = 0.2365561F;
        tooth5.rotateAngleY = 0F;
        tooth5.rotateAngleZ = 0F;
        tooth5.render(par7);
