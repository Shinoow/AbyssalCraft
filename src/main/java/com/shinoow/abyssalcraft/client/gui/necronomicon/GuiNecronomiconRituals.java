...
public class GuiNecronomiconRituals extends GuiNecronomicon {
	...
	public void initGui()
	{
		...
		if(getBookType() == 4)
			buttonList.add(ritual4 = new ButtonCategory(7, i + 14, b0 + 109, this, StatCollector.translateToLocal(ACItems.abyssalnomicon.getUnlocalizedName() + ".name"), hasRituals(4) ? ACItems.abyssalnomicon : ACItems.oblivion_catalyst));
		updateButtons();
	}
