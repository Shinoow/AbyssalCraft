...
public class ClientProxy extends CommonProxy {
	...
	public void init(){
		...
		Minecraft.getMinecraft().getItemColors().registerItemColorHandler((stack, tintIndex) -> tintIndex == 1 ? SpellUtils.getSpellColor(stack) : 16777215, ACItems.scroll, ACItems.unique_scroll);
