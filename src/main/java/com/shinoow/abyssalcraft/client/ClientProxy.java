...
public class ClientProxy extends CommonProxy {
	...
	public void preInit() {
		...
		ModelBakery.registerItemVariants(ACItems.coralium_longbow, makerl("corbow", "corbow_pulling_0", "corbow_pulling_1", "corbow_pulling_2"));
		ModelBakery.registerItemVariants(ACItems.interdimensional_cage, makerl("interdimensionalcage", "interdimensionalcage_captured"));
	...
	private void spawnParticleLegacy(String particleName, double posX, double posY, double posZ, double velX, double velY, double velZ){
