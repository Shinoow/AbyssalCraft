...
public class ACRecipeBackgrounds {

	public static final ResourceLocation RITUAL = new ResourceLocation("abyssalcraft", "textures/gui/container/ritual_nei.png");
	public static final ResourceLocation TRANSFORMATION_RITUAL = new ResourceLocation("abyssalcraft", "textures/gui/container/transformation_ritual_jei.png");
