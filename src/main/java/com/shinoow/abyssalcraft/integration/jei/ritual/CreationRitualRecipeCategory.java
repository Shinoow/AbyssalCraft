...
public class CreationRitualRecipeCategory implements IRecipeCategory {
	...
	public CreationRitualRecipeCategory(IGuiHelper guiHelper){
		...
		localizedName = I18n.format("container.abyssalcraft.creationrituals.nei");
	...
	public String getUid() {
		...
		return AbyssalCraftRecipeCategoryUid.CREATION_RITUAL;
	}
	...
	public void setRecipe(IRecipeLayout recipeLayout, IRecipeWrapper recipeWrapper, IIngredients ingredients) {
		if(recipeWrapper instanceof CreationRitualRecipeWrapper){
