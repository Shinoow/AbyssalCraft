...
public class CreationRitualRecipeCategory extends ACRecipeCategoryBase<CreationRitualRecipeWrapper> {
	...
	public CreationRitualRecipeCategory(IGuiHelper guiHelper){
		super(I18n.format("container.abyssalcraft.creationrituals.nei"), ACRecipeCategoryUid.CREATION_RITUAL);
		background = guiHelper.createDrawable(ACRecipeBackgrounds.RITUAL, 5, 11, 166, 140);
	}

	@Override
	public void setRecipe(IRecipeLayout recipeLayout, CreationRitualRecipeWrapper recipeWrapper, IIngredients ingredients) {
