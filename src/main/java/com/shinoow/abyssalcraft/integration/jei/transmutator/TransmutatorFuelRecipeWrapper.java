...
public class TransmutatorFuelRecipeWrapper implements IRecipeWrapper {
	@Nonnull
	...
	public TransmutatorFuelRecipeWrapper(@Nonnull IGuiHelper guiHelper, @Nonnull Collection<ItemStack> input, int burnTime) {
