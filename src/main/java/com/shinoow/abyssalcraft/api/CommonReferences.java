...
/**
 * A collection of numbers/strings/whatever referenced somewhere<br>
 * (fewer 'magic numbers')
 * @author shinoow
 *
 * @since 2.0.0
...
public class CommonReferences {
	...
	public static final float NECRONOMICON_MAX_ENERGY = 5000F;
	public static final float AW_NECRONOMICON_MAX_ENERGY = 10000F;
	...
	public static final int BOOKTYPE_OMT = 3;
	public static final int BOOKTYPE_FINAL = 4;
}
