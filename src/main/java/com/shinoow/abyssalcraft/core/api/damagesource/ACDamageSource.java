 ...
 */
package com.shinoow.abyssalcraft.core.api.damagesource;

import net.minecraft.util.DamageSource;

/**
 * Contains all Damagesources added in AbyssalCraft.
 * This was originally in the main mod, but moved over to Core so other mods can use it.
 * @author shinoow
 *
 */
